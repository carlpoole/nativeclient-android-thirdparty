package com.wuman.oauth.samples.microsoft;
...
/**
 * Created by brwerner on 2/26/16.
 */
public class MicrosoftActivity extends FragmentActivity {
    ...
    public static class OAuthFragment extends Fragment implements
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            AuthorizationFlow flow = new AuthorizationFlow.Builder(
                    ...
                    OAuth.JSON_FACTORY,
                    new GenericUrl(MicrosoftConstants.TOKEN_SERVER_URL),
                    new ClientParametersAuthentication(MicrosoftConstants.CLIENT_ID,
                            MicrosoftConstants.CLIENT_SECRET),
                    MicrosoftConstants.CLIENT_ID,
                    MicrosoftConstants.AUTHORIZATION_CODE_SERVER_URL)
                    .setScopes(Arrays.asList(MicrosoftScopes.READ_FULLPROFILE))
            ...
            AuthorizationDialogController controller =
                    new DialogFragmentController(getFragmentManager(), fullScreen) {
                        ...
                        public String getRedirectUri() throws IOException {
                            return MicrosoftConstants.REDIRECT_URL;
                        }
        ...
        private static class GetTokenLoader extends AsyncResourceLoader<Credential> {
            ...
            public Credential loadResourceInBackground() throws Exception {
                Credential credential =
                        oauth.authorizeExplicitly(getContext().getString(R.string.token_microsoft_explicit),
                                null, null).getResult();
        ...
        private static class DeleteTokenLoader extends AsyncResourceLoader<Credential> {
            ...
            @Override
            public Credential loadResourceInBackground() throws Exception {
                success = oauth.deleteCredential(getContext().getString(R.string.token_microsoft_explicit), null,
                        null).getResult();
